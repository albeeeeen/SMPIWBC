...
{
    public partial class ServiceMonitoring : Form
    {
        ...
        {
            //string date = DateTime.Now.ToString("yyyy-MM-dd");
            //int checkhour = Convert.ToInt32(label26.Text.Substring(0, 2));
            //int checkmin = Convert.ToInt32(label26.Text.Substring(3, 2));
            //string checkampm = label26.Text.Substring(9, 2);
            //int hour = 0, min = 0, endhour = 0, endmin = 0;
            //string ampm = "", empname = "", endampm;
            //int appointmentno = 0;
            //bool check = false;
            //try
            //{
            ...
            //        endmin = Convert.ToInt32(dataReader.GetString("Appointment_EndTime").Substring(3, 2));
            //        endampm = dataReader.GetString("Appointment_EndTime").Substring(6, 2);
            //        if (((checkhour == hour && checkmin >= min && string.Equals(ampm, checkampm, StringComparison.OrdinalIgnoreCase)) || (checkhour > hour && string.Equals(ampm, checkampm, StringComparison.OrdinalIgnoreCase))))
            //        {
            //            t1.Enabled = false;
            //            MessageBox.Show("Hey! There's an upcoming appointment");

            //            appointmentno = dataReader.GetInt32("Appointment_No");
            //            empname = dataReader.GetString("CONCAT(Employee_LName,', ',Employee_FName,' ',Employee_MidInit)");
            //            check = true;
            //            break;
            //        }
            ...
            //        {
            //            t1.Enabled = false;
            //            MessageBox.Show("Hey! A Treatment is already done");
            //            appointmentno = dataReader.GetInt32("Appointment_No");
            //            empname = dataReader.GetString("CONCAT(Employee_LName,', ',Employee_FNAMe,' ',Employee_MidInit)");
            //            check = true;
            //            break;
            ...
            //        {
            //            if (appointmentno == Convert.ToInt32(dataGridView4.Rows[j].Cells[0].Value))
            //            {
            //                dataGridView4.Rows[j].Cells[0].Style.BackColor = Color.Salmon;
            //            }
            //        }
            //        label20.Text = empname;
        ...
        void t_Tick(object sender, EventArgs e)
        {
            ...
            label26.Text = DateTime.Now.ToString("hh:mm:ss tt");
        ...
        private void ServiceMonitoring_Load(object sender, EventArgs e)
        {
        ...
        private void ServiceMonitoring_KeyDown(object sender, KeyEventArgs e)
        {
        }
