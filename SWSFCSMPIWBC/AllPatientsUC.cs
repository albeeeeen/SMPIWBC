...
namespace SWSFCSMPIWBC
{
    public partial class AllPatientsUC : UserControl
    {
        ...
        private void bunifuThinButton21_Click(object sender, EventArgs e)
        {
            ...
            adSearchTransition.ShowSync(panel3);
            panel3.Show();
            panel3.BringToFront();
            comboBox2.SelectedIndex = 0;
        }

        private void AllPatientsUC_Load(object sender, EventArgs e)
        {
